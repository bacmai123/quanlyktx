...
//                    jpn_TrangChu_317.setVisible(false);
    ...
    private void jpn_Phong1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpn_Phong1MouseClicked
        String maPhong = "MPA1";
        QuanLyPhong_140 qlphong = null;
		try {
			qlphong = new QuanLyPhong_140(maPhong);
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SQLException e) {
    ...
    private void tbDNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDNMouseClicked
        ...
        DienNuoc_317 dienNuoc_317 = null;
		try {
			dienNuoc_317 = dienNuocDao.getDienNuocByMP_T(Ma_DN, java.sql.Date.valueOf(Thang));
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SQLException e) {
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        // TODO add your handling code here:
        TaiKhoanDangNhap_324 taiKhoanDangNhap_324 = null;
		try {
			taiKhoanDangNhap_324 = taiKhoanService_324.getTaiKhoanByUser(User_name_317.getText());
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SQLException e) {
